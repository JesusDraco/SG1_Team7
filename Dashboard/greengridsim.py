...
def load_config(config_path="config.json"):
    ...
    if not config_file.exists():
        raise FileNotFoundError(f"No se encontro el archivo de configuracion: {config_file}")
...
for season in seasons:
    for strategy in strategies:
        ...
        # Grafica 2: Import / Export total del vecindario
        plt.figure(figsize=(12, 4))
        ...
        # Grafica 3: consumo total por tipo de hogar
        ...
        # Grafica 4: exportación total por wealth level
